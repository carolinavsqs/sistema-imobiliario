<?php namespace App\Http\Controllers;
	...
	class AdminFuncionariosController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->form = [];
			$this->form[] = ['label'=>'Nome','name'=>'nome','type'=>'text','validation'=>'required|min:3|max:70','width'=>'col-sm-10'];
			...
			$this->form[] = ['label'=>'Estado','name'=>'estado','type'=>'select','validation'=>'required|min:1|max:255','width'=>'col-sm-10','dataenum'=>'AC;AL;AP;AM;BA;CE;DF;ES;GO;MA;MT;MS;MG;PA;PB;PR;PE;PI;RJ;RN;RS;RO;RR;SC;SP;SE;TO'];
			$this->form[] = ['label'=>'Aniversario','name'=>'aniversario','type'=>'date','validation'=>'required|date','width'=>'col-sm-10'];
