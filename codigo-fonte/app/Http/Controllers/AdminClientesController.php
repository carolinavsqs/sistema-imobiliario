<?php namespace App\Http\Controllers;
	...
	class AdminClientesController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->form[] = ['label'=>'Cpf','name'=>'cpf','type'=>'text','validation'=>'required|min:11|max:255','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Rg','name'=>'rg','type'=>'text','validation'=>'required|min:11|max:255','width'=>'col-sm-10'];
			...
			//$this->form[] = ["label"=>"Aniversario","name"=>"aniversario","type"=>"date","required"=>TRUE,"validation"=>"required|date"];
